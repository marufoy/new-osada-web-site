document.addEventListener('DOMContentLoaded', async function() {
    ...
    if (servicesPortfolioGridContainer) {
        ...
        .then(data => {
            ...
            data.contents.forEach(work => {
                ...
                `;
                servicesPortfolioGridContainer.appendChild(item);
            });
        })
        .catch(error => {
            console.error('Error fetching services portfolio:', error);
            servicesPortfolioGridContainer.innerHTML = '<p>実績の読み込みに失敗しました。</p>';
        });
    }
    ...
    const createScrollToTopButton = () => {
        ...
        button.style.cssText = `
            ...
            border-radius: 50%; background: #224053; color: white; border: none;
